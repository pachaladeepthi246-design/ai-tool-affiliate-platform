...
```bash
git remote add encore encore://ai-tool-affiliate-platform-nd9i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ai-tool-affiliate-platform-nd9i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ai-tool-affiliate-platform-nd9i/settings/integrations/github)
